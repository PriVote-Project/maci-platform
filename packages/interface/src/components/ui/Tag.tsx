...
export const Tag = createComponent(
  "div",
  tv({
    base: "cursor-pointer font-inter inline-flex items-center justify-center gap-2 whitespace-nowrap transition border border-[var(--brand-500)] text-[var(--brand-500)] hover:bg-[var(--brand-50)] dark:border-[var(--brand-300)] dark:text-[var(--brand-300)] dark:hover:bg-white dark:hover:text-[var(--brand-500)]",
    variants: {
      size: {
